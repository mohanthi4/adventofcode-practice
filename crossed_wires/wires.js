...
// console.log(arr2);
// const array1 = arr.slice(1);
// const array2 = arr2.slice(1);
// console.log(array1);
// console.log(array2);

const data1 = (arr, arr2) => {
  for (let arrIndex = 0; arrIndex < arr.length; arrIndex++) {
    for (let i = 0; i < arr2.length; i++) {
      if (arr[arrIndex][0] === arr2[i][0]) {
        if (arr[arrIndex][1] === arr2[i][1]) {
          // console.log(i)
          // console.log(arrIndex)
          // console.log(arr2[i])
          return i+1 + arrIndex+1;
        }
      }
    }
  }
...
const data = data1(arr, arr2);
console.log(data);

// const data2 = arr.map((x) => {
//   for (let i = 0; i < arr2.length; i++) {
//     if (x[0] === arr2[i][0]) {
//       if (x[1] === arr2[i][1]) {
//         // console.log(i)
...
// const ud = distinct(data);
// const ud2 = ud.slice(1);
// console.log(ud2);
// const final = ud2.reduce((f, c) => f < c ? f : c);
// console.log(final);
